      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            ref={ref}
            className={cn(
              'flex h-11 w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-background)] px-4 py-2 text-sm text-[var(--color-text)] placeholder:text-[var(--color-text-subtle)] transition-all duration-200',
